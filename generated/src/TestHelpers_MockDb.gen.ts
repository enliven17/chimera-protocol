...
export type entities = {
  readonly AgentDelegation: entityStoreOperations<Entities_AgentDelegation_t>; 
  readonly AgentDelegationUpdatedEvent: entityStoreOperations<Entities_AgentDelegationUpdatedEvent_t>; 
  readonly BetPlacedEvent: entityStoreOperations<Entities_BetPlacedEvent_t>; 
  readonly Market: entityStoreOperations<Entities_Market_t>; 
  readonly MarketCreatedEvent: entityStoreOperations<Entities_MarketCreatedEvent_t>; 
  readonly MarketResolvedEvent: entityStoreOperations<Entities_MarketResolvedEvent_t>; 
  readonly PriceUpdate: entityStoreOperations<Entities_PriceUpdate_t>; 
  readonly PythPriceUpdatedEvent: entityStoreOperations<Entities_PythPriceUpdatedEvent_t>; 
