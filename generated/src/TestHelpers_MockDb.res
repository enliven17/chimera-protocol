...
@genType
and entities = {
    @as("AgentDelegation") agentDelegation: entityStoreOperations<Entities.AgentDelegation.t>,
    @as("AgentDelegationUpdatedEvent") agentDelegationUpdatedEvent: entityStoreOperations<Entities.AgentDelegationUpdatedEvent.t>,
    @as("BetPlacedEvent") betPlacedEvent: entityStoreOperations<Entities.BetPlacedEvent.t>,
    @as("Market") market: entityStoreOperations<Entities.Market.t>,
    @as("MarketCreatedEvent") marketCreatedEvent: entityStoreOperations<Entities.MarketCreatedEvent.t>,
    @as("MarketResolvedEvent") marketResolvedEvent: entityStoreOperations<Entities.MarketResolvedEvent.t>,
    @as("PriceUpdate") priceUpdate: entityStoreOperations<Entities.PriceUpdate.t>,
    @as("PythPriceUpdatedEvent") pythPriceUpdatedEvent: entityStoreOperations<Entities.PythPriceUpdatedEvent.t>,
  ...
  let entities = {
      agentDelegation: {
        makeStoreOperatorEntity(
          ...
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.AgentDelegation)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.AgentDelegation.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      agentDelegationUpdatedEvent: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.AgentDelegationUpdatedEvent)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.AgentDelegationUpdatedEvent.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      betPlacedEvent: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.BetPlacedEvent)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.BetPlacedEvent.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      marketCreatedEvent: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.MarketCreatedEvent)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.MarketCreatedEvent.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      marketResolvedEvent: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.MarketResolvedEvent)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.MarketResolvedEvent.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      priceUpdate: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.PriceUpdate)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.PriceUpdate.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      pythPriceUpdatedEvent: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.PythPriceUpdatedEvent)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.PythPriceUpdatedEvent.t,
            >
          ),
          ~getKey=({id}) => id,
        )
